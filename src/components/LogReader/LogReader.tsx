...
export const LogReader = () => {
    ...
    const { levelFilter, excludedClasses, searches, favourites } =
        useDataStorageDataContext();
    const { setLevelFilter, setExcludedClasses, setSearches, setFavourites } =
        useDataStorageSetterContext();
        ...
        <div className="log-reader">
            ...
            <div className="main-content">
                ...
                <div className="tabs-buttons">
                    <button
                        className={
                            currentTab === Tabs.FilteredLogs ? 'active' : ''
                        }
                    ...
                    <button
                        className={
                            currentTab === Tabs.Favorites ? 'active' : ''
                        }
